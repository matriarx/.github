...
✔️ For more information have a look at our [contributing](https://github.com/matriarx/.github/blob/main/contributing.md) documentation.
...
Our policy applies to everyone irrespective of who they are, if a person's behaviour or actions violate it, or if they are being disrespectful, abusive or disruptive in any other way, get in [contact](https://github.com/matriarx/.github/blob/main/support.md) and report it so they can be removed from the community.
